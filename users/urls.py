...
from users.views import RegisterView, ProfileView, ActivationOk, ActivationFailed, activate_account, \
    generate_new_password, NewPasswordGenereted
...
urlpatterns =[
    ...
    path('newpassword', NewPasswordGenereted.as_view(), name='newpassword'),
